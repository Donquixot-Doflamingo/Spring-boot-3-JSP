...
public class AppBasicClass {
public static void main(String[] args) {
	// launching spring context
	var context = new AnnotationConfigApplicationContext(Coupling3Confuguration.class);
...
/*
 	not a good way to call as if i return list of
	any item i will call List.class and it is really not good if two return type of list is present in the beans
	no unique bean found exception will be thrown also if two beans return same class we will get the same exception
